...
import type { ValidationError, ValidationNode } from '~~/layers/shared/app/types/validationError';
...
export function useValidation() {
  ...
  function getNestedValue(obj: ValidationNode | undefined, path: string): ValidationNode | undefined {
    ...
    return path
      .split('.')
      .reduce<unknown>(
        (acc, key) => (acc && typeof acc === 'object' ? (acc as ValidationNode)[key] : undefined),
        obj,
      ) as ValidationNode | undefined;
  }
